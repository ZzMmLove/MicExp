...
/**
 * Entity mapped to table "exp_list".
 */
public class Experiment {
    ...
    public Experiment(Long id, String gid, String cateid, String gradeid, String name, String img_url, String img_url_s, String html5_url, String time) {
        this.id = id;
        this.gid = gid;
        this.cateid = cateid;
