...
/** 
 * DAO for table "chuangke_list".
*/
public class ChuangKeDao extends AbstractDao<ChuangKe, Long> {

    public static final String TABLENAME = "chuangke_list";

    /**
     * Properties of entity ChuangKe.<br/>
    ...
    */
    ...
    public ChuangKeDao(DaoConfig config) {
        super(config);
    }
    
    public ChuangKeDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"chuangke_list\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"chuangke_list\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(DatabaseStatement stmt, ChuangKe entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public ChuangKe readEntity(Cursor cursor, int offset) {
        ChuangKe entity = new ChuangKe( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, ChuangKe entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(ChuangKe entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(ChuangKe entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
