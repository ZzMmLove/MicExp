...
public class ScienceDao extends AbstractDao<Science, Long> {
    ...
    /**
     * Properties of entity Science.<br/>
    ...
    */
    ...
    public ScienceDao(DaoConfig config) {
        super(config);
    }
    
    public ScienceDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"science_list\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"science_list\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(DatabaseStatement stmt, Science entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public Science readEntity(Cursor cursor, int offset) {
        Science entity = new Science( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Science entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Science entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Science entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
