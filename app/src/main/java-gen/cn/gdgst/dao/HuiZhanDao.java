...
/** 
 * DAO for table "huizhan_list".
*/
public class HuiZhanDao extends AbstractDao<HuiZhan, Long> {

    public static final String TABLENAME = "huizhan_list";

    /**
     * Properties of entity HuiZhan.<br/>
    ...
    */
    ...
    public HuiZhanDao(DaoConfig config) {
        super(config);
    }
    
    public HuiZhanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"huizhan_list\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"huizhan_list\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(DatabaseStatement stmt, HuiZhan entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public HuiZhan readEntity(Cursor cursor, int offset) {
        HuiZhan entity = new HuiZhan( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, HuiZhan entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(HuiZhan entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(HuiZhan entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
