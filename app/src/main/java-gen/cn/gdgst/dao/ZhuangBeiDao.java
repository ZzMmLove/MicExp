...
/** 
 * DAO for table "zhuangbei_list".
*/
public class ZhuangBeiDao extends AbstractDao<ZhuangBei, Long> {

    public static final String TABLENAME = "zhuangbei_list";

    /**
     * Properties of entity ZhuangBei.<br/>
    ...
    */
    ...
    public ZhuangBeiDao(DaoConfig config) {
        super(config);
    }
    
    public ZhuangBeiDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"zhuangbei_list\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"zhuangbei_list\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(DatabaseStatement stmt, ZhuangBei entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public ZhuangBei readEntity(Cursor cursor, int offset) {
        ZhuangBei entity = new ZhuangBei( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, ZhuangBei entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(ZhuangBei entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(ZhuangBei entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
