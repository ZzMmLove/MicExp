...
/** 
 * DAO for table "midche_list".
*/
public class MidCheDao extends AbstractDao<MidChe, Long> {

    public static final String TABLENAME = "midche_list";

    /**
     * Properties of entity MidChe.<br/>
    ...
    */
    ...
    public MidCheDao(DaoConfig config) {
        super(config);
    }
    
    public MidCheDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"midche_list\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"midche_list\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(DatabaseStatement stmt, MidChe entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public MidChe readEntity(Cursor cursor, int offset) {
        MidChe entity = new MidChe( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MidChe entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(MidChe entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(MidChe entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
