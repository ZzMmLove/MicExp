...
/** 
 * DAO for table "midphy_list".
*/
public class MidPhyDao extends AbstractDao<MidPhy, Long> {

    public static final String TABLENAME = "midphy_list";

    /**
     * Properties of entity MidPhy.<br/>
    ...
    */
    ...
    public MidPhyDao(DaoConfig config) {
        super(config);
    }
    
    public MidPhyDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"midphy_list\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"midphy_list\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(DatabaseStatement stmt, MidPhy entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public MidPhy readEntity(Cursor cursor, int offset) {
        MidPhy entity = new MidPhy( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, MidPhy entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(MidPhy entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(MidPhy entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
