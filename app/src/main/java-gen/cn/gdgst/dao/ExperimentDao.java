...
/** 
 * DAO for table "exp_list".
*/
public class ExperimentDao extends AbstractDao<Experiment, Long> {

    public static final String TABLENAME = "exp_list";

    /**
     * Properties of entity Experiment.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property Html5_url = new Property(7, String.class, "html5_url", false, "HTML5_URL");
        public final static Property Time = new Property(8, String.class, "time", false, "TIME");
    };


    public ExperimentDao(DaoConfig config) {
        super(config);
    }
    
    public ExperimentDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"exp_list\" (" + //
                ...
                "\"HTML5_URL\" TEXT," + // 7: html5_url
                "\"TIME\" TEXT);"); // 8: time
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"exp_list\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(DatabaseStatement stmt, Experiment entity) {
        stmt.clearBindings();
        ...
        String html5_url = entity.getHtml5_url();
        if (html5_url != null) {
            stmt.bindString(8, html5_url);
        }
    ...
    /** @inheritdoc */
    @Override
    public Experiment readEntity(Cursor cursor, int offset) {
        Experiment entity = new Experiment( //
            ...
            cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), // html5_url
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Experiment entity, int offset) {
        ...
        entity.setHtml5_url(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));
        entity.setTime(cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Experiment entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Experiment entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
