...
/** 
 * DAO for table "activity_exam_list".
*/
public class PeiXunDao extends AbstractDao<PeiXun, Long> {

    public static final String TABLENAME = "activity_exam_list";

    /**
     * Properties of entity PeiXun.<br/>
    ...
    */
    ...
    public PeiXunDao(DaoConfig config) {
        super(config);
    }
    
    public PeiXunDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"activity_exam_list\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"activity_exam_list\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(DatabaseStatement stmt, PeiXun entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public PeiXun readEntity(Cursor cursor, int offset) {
        PeiXun entity = new PeiXun( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, PeiXun entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(PeiXun entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(PeiXun entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
