...
public class MingShiAdapter extends BaseAdapter {
	...
	public MingShiAdapter(Context context, List<MingShi> mingshiList) {
		this.context = context;
		this.MingshiList = mingshiList;
	}

	@Override
	public int getCount() {
		// TODO Auto-generated method stub
		return MingshiList.size();
	...
	public Object getItem(int position) {
		// TODO Auto-generated method stub
		return MingshiList.get(position);
	}
	...
	public View getView(final int position, View view, ViewGroup viewgroup) {
		...
		final MingShi expitem = MingshiList.get(position);
		if (view == null) {
					...
					new Thread() {
						public void run() {
							try {
								...
								rawParams.put("id", MingshiList.get(position).getId().toString());
									...
									handler.post(new Runnable() {
										...
										public void run() {
											iv_collect.setImageResource(
													R.mipmap.detail_interaction_bar_favorite_pressed);
											COLLECTTAG = 1;
											...
											editor.putString("videoid", expitem.getId().toString());
											editor.commit();// 提交修改
								...
								if (getaddInfo) {
									handler.post(new Runnable() {
										...
										public void run() {
											...
											sp = context.getSharedPreferences("addInfo", Context.MODE_PRIVATE);
											Editor editor = sp.edit();// 获取编辑器
											editor.putString("videoid", expitem.getGid());
											editor.commit();// 提交修改
