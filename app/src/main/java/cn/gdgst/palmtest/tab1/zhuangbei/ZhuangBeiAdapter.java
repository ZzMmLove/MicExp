...
// 定义当前listview是否在滑动状态
	...
	public ZhuangBeiAdapter(Context context, List<ZhuangBei> chuangkeList) {
	...
	public View getView(final int position, View view, ViewGroup viewgroup) {
		// TODO Auto-generated method stub
		final viewholder vd;
		final ZhuangBei expitem = ChuangKeList.get(position);
		if (view==null) {
		...
		vd.vid_tv.setText(expitem.getTitle()); //  exp_tv设置文本
