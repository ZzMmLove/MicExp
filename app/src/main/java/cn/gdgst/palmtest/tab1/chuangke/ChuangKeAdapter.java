...
public class ChuangKeAdapter extends BaseAdapter {
	...
	public ChuangKeAdapter(Context context, List<ChuangKe> chuangkeList) {
	...
	public View getView(final int position, View view, final ViewGroup viewgroup) {
		// TODO Auto-generated method stub
		// Log.i("getview", "position:" + position + "convertView:" + view);
		final viewholder vd;
		final ChuangKe expitem = ChuangKeList.get(position);
		if (view == null) {
